...
// Source: github.com/LeonDavidZipp/go_simple_bank/db/sqlc (interfaces: Store)
//
// Generated by this command:
//
//	mockgen -package mockdb -destination db/mock/store.go github.com/LeonDavidZipp/go_simple_bank/db/sqlc Store
//
